  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-center md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="ml-20 max-w-course-card max-w-[424px] w-full z-10 shadow-custom-card shadow-xl rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] ">
          {playerData ? (
            <Youtube
          ...
          <div className="p-5">
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-[18px] list-disc text-gray-500">
